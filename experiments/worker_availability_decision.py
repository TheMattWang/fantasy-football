"""Does correcting the Questionable multiplier change the LINEUP, or only the number?
...
for season in SEASONS:
    ...
    for week in WEEKS:
        ...
        lineups = {}
        for tag, mult in (("old", OLD), ("new", NEW)):
            av.STATUS_MULTIPLIER["Questionable"] = mult
...
av.STATUS_MULTIPLIER["Questionable"] = OLD      # leave the module as found
